                ...
                <ol className={"power-stats"}>
                    {
                        powerStatEntries.map(entry => {
                            const [key, value] = entry;
                                return (
                                    <li key={key}>
                                        <span className="stat-name">{key}</span> <span className="stat-number">{value}</span>
                                    </li>
                                )
                        })
                    }
    ...
    return (
        <>
            <article className="mini-hero-card">
                ...
                <button className={'button accent'} type={"button"} onClick={() => handleHeroCardAction(hero.id, hero.onDuty)}>
